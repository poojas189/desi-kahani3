...
export class AppComponent {
      ...
      if (events instanceof NavigationEnd) {
        ...
        switch (events.url) {
          ...
          case "/more-apps":
            ...
            this.displayBackIcon = true;
            break;
          case "/quote-viewer?view=pushnotification":
            this.displayHomeIcon = true;
            this.displayBackIcon = true;
            this.headerLabel = 'Notifications';
            break;
          default:
  ...
  async onRateFromExit() {
    ...
    if (this.platform.is('android')) {
      window.open('http://play.google.com/store/apps/details?id=com.corlogix.storythree', '_system');
    } else if (this.platform.is('ios')) {
      window.open('https://itunes.apple.com/gb/com.corlogix.storythree', '_system');
    }
  }
